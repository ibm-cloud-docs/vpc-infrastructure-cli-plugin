...
`ibmcloud is flow-log 72251a2e-d6c5-42b4-97b0-b5f8e8d1f479 --json' View details of a flow log in JSON format.
...
`ibmcloud is flow-log-create --bucket bucket-name --target 72251a2e-d6c5-42b4-97b0-b5f8e8d1f479 --name my-flow-log` Create a flow log named `my-flow-log`.
...
`ibmcloud is flow-log-delete 72251a2e-d6c5-42b4-97b0-b5f8e8d1f479 -f` Delete a flow log without confirmation.
...
`ibmcloud is flow-log-update 72251a2e-d6c5-42b4-97b0-b5f8e8d1f479 --name new-name-flow-log` Update the name of a flow log.
