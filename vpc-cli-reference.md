...
- **--confidential-compute-mode**: The confidential compute mode to use for this virtual server instance. If unspecified, the default confidential compute mode from the profile is used. One of: **disabled**, **sgx**.
